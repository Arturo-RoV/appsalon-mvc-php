...
function mostrarSeccion() {
    ...
    // Seleccionar el sección con el paso
...
function seleccionarHora() {
    ...
    inputHora.addEventListener('input', function(e) {
        ...
        if (hora < 10 || hora > 18) {
            e.target.value = '';
            mostrarAlerta('El horario de atención es de 10 a 18 horas', 'error', '.formulario');
        } else {
...
async function reservarCita() {
    ...
    if (resultado.resultado) {
        ...
        Swal.fire({
            icon: "error",
            title: "Error",
            text: "Hubo un error al crear la cita, intenta nuevamente",
            timer: 2000
          }).then( () => {
            window.location.reload();
      });
